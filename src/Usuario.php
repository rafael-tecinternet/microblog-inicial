...
final class Usuario {
    ...
    public function listarUsuario():array{
        ...
        $sql = "SELECT usuarios.id, usuarios.nome, usuarios.email, cadastro.endereco, cadastro.cep, cadastro.cidade, cadastro.numero, cadastro.complemento, cadastro.bairro FROM usuarios LEFT JOIN cadastro
