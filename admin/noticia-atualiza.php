...
if(isset($_POST['atualizar'])){
    ...
    /* Lógica/Algotitmo para atualizar a foto se necessário */
    /* Se o campo imagem estiver vazio, então significa que o usuário NÂO QUER MUDAR DE IMAGEM. Ou seja, vamos manter a imagem existente. */
    if(empty($_FILES['imagem']['name'])){
        $noticia->setImagem($_POST['imagem-existente']);
    } else {
        /* Se não, então pegamos a referência (nome e extensão) da nova imagem e fazemos o processo de upload e envio desta referência para o Objeto */
    ...
    <article class="col-12 bg-white rounded shadow my-1 py-4">
        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control"  value="<?=$dados['imagem']?>" type="text" id="imagem-existente" name="imagem-existente" readonly>
            </div>
            ...
            <div class="mb-3">
                <p>Deixar a notícia em destaque?
                    <input type="radio" class="btn-check" name="destaque" id="nao" autocomplete="off"  value="nao" <?php if($dados['destaque'] == 'nao') echo ' checked ' ?>>
